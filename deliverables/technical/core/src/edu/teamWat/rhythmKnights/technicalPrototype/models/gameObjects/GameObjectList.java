...
public class GameObjectList implements Iterable<GameObject>{
	...
	/** The list of game objects managed by this object. */
	...
	public GameObjectList(int size) {
		...
		// 	gameobjs[ii] = new GameObject(ii, 0, 0);
		//}
		
		// enemyModel  = new TexturedMesh(shipMesh,enemyTexture);
		// playerModel = new TexturedMesh(shipMesh,playerTexture);
		// fireModel   = new TexturedMesh(fireMesh,fireTexture);
		// fireModel.setColor(new Color(FIRE_COLOR));
	}
	...
	/**
	 * Returns a GameObject iterator, satisfying the Iterable interface.
	 *
	 * This method allows us to use this object in for-each loops.
	 *	 
	 * @return a game object iterator.
	 */
	 ...
	 */
	private class ShipIterator implements Iterator<GameObject> {
		/** The current position in the game object list */
		public int pos = 0;
