...
public class LoadingMode implements Screen, InputProcessor, ControllerListener {
	 ...
	 * <p/>
	 * The buttonCode is controller specific. This listener only supports the start button on an X-Box controller.  This
	 * outcome of this method is identical to pressing (but not releasing) the play button.
	 *
	 ...
	 * <p/>
	 * The buttonCode is controller specific. This listener only supports the start button on an X-Box controller.  This
	 * outcome of this method is identical to releasing the the play button after pressing it.
	 *
	 * @param controller The game controller
	 * @param buttonCode The button pressed
	 * @return whether to hand the event to other listeners.
	 ...
	 * <p/>
	 * The accelerometerCode is controller specific. The value is a Vector3 representing the acceleration on a 3-axis
