...
public class GameplayController {
	...
	public GameplayController() {
		...
		path0[0] = new Vector2(5,0); path0[1] = new Vector2(4,0); path0[2] = new Vector2(3,0); path0[3] = new Vector2(4,0); 
		enemies[0] = new Enemy(new Vector2(5,0), path0);
		
		path1[0] = new Vector2(4,2); path1[1] = new Vector2(5,2); path1[2] = new Vector2(4,2); path0[1] = new Vector2(3,2); 
