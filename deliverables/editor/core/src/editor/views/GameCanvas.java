...
public class GameCanvas {
	 ...
	 *
	 * Width, height, and fullscreen are taken from the LWGJApplicationConfig object used to start the application. This
	 * constructor initializes all of the necessary graphics objects.
	 */
	public GameCanvas() {
		active = false;
