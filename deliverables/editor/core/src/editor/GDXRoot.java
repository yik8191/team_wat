...
public class GDXRoot extends Game implements ScreenListener {
	...
	/**
	 * Called when the Application is first created.  This is method immediately loads assets for the loading screen,
	 * and prepares the asynchronous loader for all other assets.
	 */
	public void create() {
	...
	/**
	 * The given screen has made a request to exit its player mode.  The value exitCode can be used to implement menu
	 * options.
	 *
