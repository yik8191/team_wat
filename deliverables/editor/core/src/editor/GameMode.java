...
import editor.models.gameObjects.*;
import editor.utils.ScreenListener;
...
/**
 * The primary controller class for the game. While GDXRoot is the root class, it delegates all of the work to the
...
public class GameMode implements Screen {
	 ...
	 *
	 * All instances of the game use the same assets, so this is a static method. This keeps us from loading the assets
	 * multiple times.
	 *
...
//		RhythmController.PreloadContent(manager);
	 ...
	 *
	 * All instance of the game use the same assets, so this is a static method. This keeps us from loading the assets
	 * multiple times.
	 *
	 * The asset manager for LibGDX is asynchronous.  That means that you tell it what to load and then wait while it
...
//		RhythmController.LoadContent(manager);
	...
	/**
	 * Unloads the assets for this game. <p/> This method erases the static variables.  It also deletes the associated
	 * textures from the asset manager.
	 *
	 * @param manager Reference to global asset manager.
	 */
...
//	private GameplayController gameplayController;
	 ...
	 *
	 * This constructor initializes the models and controllers for the game.  The view has already been initialized by
	 * the root class.
	 */
