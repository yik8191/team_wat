 ...
 */
package edu.teamWat.rhythmKnights.alpha.utils;

import com.badlogic.gdx.Screen;

/**
 * A listener class for responding to a screen's request to exit. <p/> This interface is almost always implemented by
 * the root Game class.
 */
public interface ScreenListener {

	/**
	 * The given screen has made a request to exit its player mode. <p/> The value exitCode can be used to implement
	 * menu options.
	 *
