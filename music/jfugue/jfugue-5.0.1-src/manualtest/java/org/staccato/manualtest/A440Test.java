...
/**
 *  This test ensures that A5 - the A above Middle-C - sounds the same as MIDI note 69 and frequency 440Hz,
 *  and that A is the same as A5 (i.e., 5 is the default octave)
 */
public class A440Test {
