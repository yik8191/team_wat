...
public class NoteSubparserTest extends JFugueTestHelper 
{
    ...
    public void testSimpleNotes() {
        ...
        assertTrue(compare("C5q", NOTE_PARSED, new Note(60).setDuration(0.25d)));
    ...
    public void testLowestNote() {
    	assertTrue(compare("C0", NOTE_PARSED, new Note(0)));
    }

    @Test
    public void testHighestNote() {
    	assertTrue(compare("G10", NOTE_PARSED, new Note(127)));
    }
    ...
    public void testDyanmicsUsingLetters() {
        assertTrue(compare("Ca20", NOTE_PARSED, new Note(60).setOnVelocity((byte)20)));
        assertTrue(compare("D4d20", NOTE_PARSED, new Note(50).setOffVelocity((byte)20)));
        assertTrue(compare("Bb3a10d20", NOTE_PARSED, new Note(46).setOnVelocity((byte)10).setOffVelocity((byte)20)));
    }

    @Test
    public void testDyanmicsWithDurations() {
        assertTrue(compare("Ch.a20", NOTE_PARSED, new Note(60).setDuration(0.75d).setOnVelocity((byte)20)));
        assertTrue(compare("c2w2a2", NOTE_PARSED, new Note(24).setDuration(2.0d).setOnVelocity((byte)2)));
        assertTrue(compare("D4/0.25d20", NOTE_PARSED, new Note(50).setDuration(0.25d).setOffVelocity((byte)20)));
        assertTrue(compare("Bb3/-1.0-a10d20", NOTE_PARSED, new Note(46).setDuration(1.0d).setStartOfTie(true).setEndOfTie(true).setOnVelocity((byte)10).setOffVelocity((byte)20)));
    }
    ...
    public void testCombinedLetterNotes() {
        assertTrue(compare("E4q+C4q", NOTE_PARSED, new Note(48, 0.25d).setFirstNote(false).setHarmonicNote(true)));
    }
    ...
    public void testInternalIntervalWithFlat() {
    	assertTrue(compare("C'6bq", NOTE_PARSED, new Note(68, 0.25d)));
    }

    @Test
    public void testInternalIntervalWithSharp() {
    	assertTrue(compare("C'6#q", NOTE_PARSED, new Note(70, 0.25d)));
    }
