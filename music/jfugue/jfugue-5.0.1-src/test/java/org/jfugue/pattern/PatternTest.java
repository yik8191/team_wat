...
public class PatternTest {
    ...
    public void testAddToNoteElements1() {
    	...
    	Pattern pattern = new Pattern("T60 A | B V1 C").addToEachNoteElement("q");
    ...
    public void testAddToNoteElements2() {
    	...
    	Pattern pattern = new Pattern("T60 A | B V1 C").addToEachNoteElement("q i");
    ...
    public void testAddToNoteElements3() {
    	...
    	Pattern pattern = new Pattern("T60 A | B V1 C").addToEachNoteElement("q i s");
    ...
    public void testAddToNoteElements4() {
    	...
    	Pattern pattern = new Pattern("T60 A | B V1 C").addToEachNoteElement("q i s w");
    	assertTrue(pattern.toString().equals("T60 Aq | Bi V1 Cs"));
    }
    ...
    public void testAddToNoteElements5() {
    	...
    	Pattern pattern = new Pattern("[BASS_DRUM] [HI_HAT] [OPEN_CUICA]").addToEachNoteElement("q i s w").setVoice(9);
    ...
    public void testAddToNoteElements6() {
    	...
    	Pattern pattern = new Pattern("T120 V9 I[Piano]").addToEachNoteElement("q i s w");
